...
class MultiLatentModel(nn.Module):
    ...
    def forward(self, l1_x_context, l1_y_context, l1_x_target, l2_x_context, l2_y_context, l2_x_target, \
                    l1_x_all=None, l1_y_all=None, l2_x_all=None, l2_y_all=None):
        """
        ...
        if l2_x_all is not None:
            l1_z_mu_all, l1_z_cov_all, l1_posterior_z = self.l1_latent_encoder(l1_x_all, l1_y_all)
            l2_z_mu_all, l2_z_cov_all, l2_posterior_z = self.l2_latent_encoder(l2_x_all, l2_y_all)
        ...
        # For Generation
            ...
            l1_z = l1_prior_z
            l2_z = l2_prior_z
            l1_target = l1_x_target
            l2_target = l2_x_target
