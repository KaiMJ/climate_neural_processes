...
if __name__ == "__main__":
    ...
    l2_x_data = sorted(glob.glob(f"{config['data_dir']}/batch_{fidelity}_data/inputs_*"), key=sort_batch_fn)
    l2_y_data = sorted(glob.glob(f"{config['data_dir']}/batch_{fidelity}_data/outputs_*"), key=sort_batch_fn)
    ...
    val_dataset = l2Dataset(l2_x_val, l2_y_val, x_scaler=x_scaler_minmax, y_scaler=y_scaler_minmax, variables=26)
